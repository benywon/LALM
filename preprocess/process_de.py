# -*- coding: utf-8 -*-
"""
 @Time    : 2020/5/21 下午6:32
 @FileName: process_de.py
 @author: 王炳宁
...
sp.load('/search/odin/bingning/data/germann/sp.30000.model')
...
def get_desquad():
    dev_data = process('/search/odin/bingning/data/germann/mrc/dev-context-de-question-de.json')
    dump_file(dev_data, '../data/dev.de.obj')
    train_data = process('/search/odin/bingning/data/germann/mrc/train-context-de-question-de.json')
    dump_file(train_data, '../data/train.de.obj')
